...
function MacroPie({ pro, fat, carb, cal, revealed = false }) {
  ...
  const segments = [
    ...
    { label:'Healthy Fat', kcalVal: fK, color:'#D4A017' },
  ]
  ...
  const legend = [
    ...
    { l:'Healthy Fat', pct: ((fK / totalK) * 100).toFixed(1), c:'#D4A017' },
  ]
        ...
        <div style={{padding:'14px 16px 0',animation:contentAnim('fadeUp',0.28)}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
            {[
              ...
              {label:'Healthy Fat', val:p.fat,   line:'#D4A017'},
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
                  {[
                    ...
                    { val:p.fat,   line:'#D4A017', label:'Healthy Fat' },
